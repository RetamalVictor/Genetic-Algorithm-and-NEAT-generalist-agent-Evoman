...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if game.start == 1:
            ...
            if (
                self.bullets == 0
            ):  # if the bubblues have gone away, enemy is abble to realease new bubbles.
            ...
            if self.rect.colliderect(game.player.rect):
                ...
                game.player.hurt = (
                    5  # Sets flag to change the player image when he is hurt.
                )
...
class Bullet_e72(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        self.rect.x += (
            self.direction * 200 * dt * 0.5
        )  # moves the bullets on the axis x
