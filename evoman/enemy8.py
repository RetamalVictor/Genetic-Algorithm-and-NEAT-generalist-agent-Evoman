...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if game.enemymode == "static":  # enemy controlled by static movements
            ...
            if (self.timeenemy >= 1 and self.timeenemy < 10) or (
                self.timeenemy >= 20 and self.timeenemy < 30
            ):
                atack1 = 1
            else:
                atack1 = 0
            ...
            if (
                (
                    abs(self.rect.left - game.player.rect.left) <= 200
                    or abs(self.rect.right - game.player.rect.right) <= 200
                )
            ) and not self.gun_cooldown:
                atack6 = 1
            else:
                atack6 = 0
            ...
            if len(actions) < 6:
                game.print_logs(
                    "ERROR: Enemy 1 controller must return 6 decision variables."
                )
                sys.exit(0)
...
class Bullet_e8(pygame.sprite.Sprite):
    ...
    def update(self, dt, game):
        ...
        if not (
            abs(self.rect.left - game.player.rect.left) <= 10
            or abs(self.rect.right - game.player.rect.right) <= 10
        ):
