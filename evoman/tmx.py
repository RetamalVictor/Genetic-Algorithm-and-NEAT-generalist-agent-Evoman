...
class Object(object):
    ...
    def __init__(
        self, type, x, y, width=0, height=0, name=None, gid=None, tile=None, visible=1
    ):
        self.type = type
        self.px = x
        self.left = x
...
class ObjectLayer(object):
    ...
    def collide(self, rect, propname):
        ...
        """
        r = []
        for object in self.get_in_region(rect.left, rect.top, rect.right, rect.bottom):
...
class SpriteLayer(pygame.sprite.AbstractGroup):
    ...
    def draw(self, screen):
        ...
        for sprite in self.sprites():
            ...
            area = pygame.Rect((0, 0), (sprite.rect.width, sprite.rect.height))
